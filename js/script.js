...
let data = [
    ...
    { "label": "voiture" },
    { "label": "Perdu !" },
    { "label": "1 playstation 5" },
    { "label": "1 clé usb 32go"},
    { "label": "Perdu !" }, 
    { "label": "1 livre de cuisine" },
    { "label": "Perdu !" },
    { "label": "1 scooter"},
    { "label": "Perdu !"},
    { "label": "1 weekend a la montagne" },
    { "label": "une pomme"}
];
...
function spin(d) {
    ...
    let ps = 360 / data.length, pieslice = Math.round(1440 / data.length), rng = Math.floor((Math.random() * 1440) + 360);
